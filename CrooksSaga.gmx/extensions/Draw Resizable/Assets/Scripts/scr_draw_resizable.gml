/// scr_draw_resizable(sprite_index, width, height, pivot_x, pivot_y)
/*
...
var width = floor(argument1 * image_xscale);
var height = floor(argument2 * image_yscale);
var pivot_x = abs(argument3);
var pivot_y = abs(argument4);
...
// Offset calculations
xx = floor(x - pivot_x * width);
yy = floor(y - pivot_y * height);
